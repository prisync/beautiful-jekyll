---
layout: post
title: PHP Geliştiricisi Arıyoruz
subtitle: Anahtar kelimeler – PHP, Yii Framework, Web scraping, HTTP, Linux, MySQL, Bash, RabbitMQ, Git
share-img: https://prisync.com/img/prisync-logo-fb-share.png
---

Prisync'te geliştirmeye devam ettiğimiz ürüne katkı sağlamak üzere 2+ yıl tecrübeli bir PHP back-end geliştirici arıyoruz. 
 ...
 * İngilizce bilmesini -kendine yetecek kadardan biraz daha fazla- bekliyoruz. 
## Biz ne sunuyoruz:
 * 2013'ten beri piyasada olan bir şirketiz.
 
 * 2014 yılında Galata Business Angels ve BIC'den yatırım almıştık. Aynı zamanda da Tübitak ve KOSGEB'ce desteklenen bir şirketiz. [2018 yılında Avustralyalı rakibimiz Spotlite'ı](https://webrazzi.com/2019/03/28/turkiye-merkezli-teknoloji-firmasi-prisync-avustralyali-rakibi-spotlitei-satin-aldi/), [2019'da İngiliz rakibimiz CompetitorPriceWatch'u](https://webrazzi.com/2020/05/11/prisync-competitor-price-watch-satin-aldi/) satın aldık. 
 ...
 * Türkiye'den çalışarak, dünyanın her yerine hizmet veren bir startup'ız, 57 ülkeden müşterisi olan bir SaaS ürünüyüz. Kariyer gelişimi bağlamında, veri operasyonları ve ölçekleme üzerinde uğraşan insanlarla birlikte çalışarak, veriye dayalı global bir SaaS projesinin tüm süreçlerini gözlemleme şansı elde edebileceksiniz.
